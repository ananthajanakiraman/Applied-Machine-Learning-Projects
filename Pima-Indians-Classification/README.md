...
Homework1 Problem1 – Used dataset from [http://archive.ics.uci.edu/ml/datasets/Pima+Indians+Diabetes](http://archive.ics.uci.edu/ml/datasets/Pima+Indians+Diabetes)

Homework1 Problem2 – Used dataset from [http://yann.lecun.com/exdb/mnist/](http://yann.lecun.com/exdb/mnist/)

**References:**

I referred to the sample code that Prof. David Forsyth shared in his web page - [http://luthuli.cs.uiuc.edu/~daf/courses/AML-18/aml-home.html](http://luthuli.cs.uiuc.edu/~daf/courses/AML-18/aml-home.html)
...
I referred to various examples in Github and stack overflow for reading binary files

I used the following R packages for Homework1 &amp; Homework2 – e1071, caret, klaR, h2o, imager, stats.

**Homework1 Problem1 -  Part A**
